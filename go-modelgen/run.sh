...
go install
rm ~/DustProxy.invite
~/go/bin/DustTool newid -o ~/DustProxy.invite test 127.0.0.1:16667 m=http >~/DustProxy.bridge
...
~/go/bin/DustProxy --incomplete -c google.com:80 in ~/DustProxy.invite &
echo "Connecting to $DUSTPROXYID"
~/go/bin/DustProxy --incomplete -r 127.0.0.1 -l 127.0.0.1:16680 out 127.0.0.1:16667 $DUSTPROXYID m=http
popd
